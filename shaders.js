...
uniform float time;
uniform float rcolor1;
uniform float gcolor1;
uniform float bcolor1;
uniform float rcolor2;
uniform float gcolor2;
uniform float bcolor2;

void main() {
	vec3 color = mix(vec3(rcolor1, gcolor1, bcolor1), vec3(rcolor2, gcolor2, bcolor2), qnoise * -1.0);
